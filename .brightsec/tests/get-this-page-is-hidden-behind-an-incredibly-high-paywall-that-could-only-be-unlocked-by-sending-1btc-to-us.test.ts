...
test('GET /this/page/is/hidden/behind/an/incredibly/high/paywall/that/could/only/be/unlocked/by/sending/1btc-to-us', { signal: AbortSignal.timeout(timeout) }, async () => {
  await runner
    .createScan({
      tests: ['unvalidated_redirect', 'csrf', 'xss', 'sqli', 'ssrf', 'osi', 'lfi', 'rfi', 'jwt', 'secret_tokens', 'open_database', 'proto_pollution', 'server_side_js_injection', 'ssti', 'stored_xss', 'xxe'],
